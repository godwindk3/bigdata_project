...
class LiveTracker:
    ...
    def __start_session(self): # checked
        if not self.session_video_info.is_live: # 
            raise NotLiveVideoError # chi track comment khi video dang live
    ...
    def __start_producer(self): # checked
        try:
    ...
    def get_video_info(self,video_link): # checked
